<?php 
    ...
    if($v1=='Todos' && $v2=='Todos'){
      ...
      e.imagen as imagen1
                ...
                WHERE d.nombre='Polo cuello redondo'
                GROUP BY c.nombre";
      ...
      $consulta3="SELECT S.nombre as NombreSubcategoria,C.nombre as Color, sum(
                    ...
                    FROM Producto as P
                      ...
                      LEFT JOIN Subcategoria as S ON P.idSubcategoria=S.idSubcategoria
                        ...
                        HAVING S.nombre='Polo cuello redondo'";
    }
    ...
    if($v1!='Todos' && $v2=='Todos'){
      ...
      e.imagen as imagen1
                                  ...
                                  LEFT JOIN Subcategoria as d on a.idSubcategoria=d.idSubcategoria
                                  LEFT JOIN Imagen as e on a.idProducto=e.idProducto AND e.tipoVista='a'
                WHERE d.nombre='Polo cuello redondo' AND a.idTalla='$v1'
                GROUP BY c.nombre";
    ...
    if($v1=='Todos' && $v2!='Todos'){
      ...
      e.imagen as imagen1
                                  ...
                                  LEFT JOIN Subcategoria as d on a.idSubcategoria=d.idSubcategoria
                                  LEFT JOIN Imagen as e on a.idProducto=e.idProducto AND e.tipoVista='a'
                WHERE d.nombre='Polo cuello redondo' AND a.idColor='$v2'
                GROUP BY c.nombre";
    ...
    if($v1!='Todos' && $v2!='Todos'){
      ...
      e.imagen as imagen1
                                  ...
                                  LEFT JOIN Subcategoria as d on a.idSubcategoria=d.idSubcategoria
                                  LEFT JOIN Imagen as e on a.idProducto=e.idProducto AND e.tipoVista='a'
                WHERE d.nombre='Polo cuello redondo' AND a.idTalla='$v1' AND a.idColor='$v2'
                GROUP BY c.nombre";
          ...
          <ul class="nav flex-column formato-categoria-filtro">
            ...
            <!--Filtros-->
             <div class="container formato-filtro">
                ...
                ?>
              <h2>FILTRAR POR :</h2>
              <form action="filtro_polo_cuello_redondo.php" method="GET">
