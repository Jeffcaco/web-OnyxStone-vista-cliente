<?php 
    ...
    if($v1!='Todos' && $v2=='Todos'){
      ...
      e.imagen as imagen1
                                  ...
                                  LEFT JOIN Subcategoria as d on a.idSubcategoria=d.idSubcategoria
                                  LEFT JOIN Imagen as e on a.idProducto=e.idProducto AND e.tipoVista='a'
                WHERE d.nombre='Bividi' AND a.idTalla='$v1'
                GROUP BY c.nombre";
    ...
    if($v1=='Todos' && $v2!='Todos'){
      ...
      e.imagen as imagen1
                                  ...
                                  LEFT JOIN Subcategoria as d on a.idSubcategoria=d.idSubcategoria
                                  LEFT JOIN Imagen as e on a.idProducto=e.idProducto AND e.tipoVista='a'
                WHERE d.nombre='Bividi' AND a.idColor='$v2'
                GROUP BY c.nombre";
    ...
    if($v1!='Todos' && $v2!='Todos'){
      ...
      e.imagen as imagen1
                                  ...
                                  LEFT JOIN Subcategoria as d on a.idSubcategoria=d.idSubcategoria
                                  LEFT JOIN Imagen as e on a.idProducto=e.idProducto AND e.tipoVista='a'
                WHERE d.nombre='Bividi' AND a.idTalla='$v1' AND a.idColor='$v2'
                GROUP BY c.nombre";
      ...
      <div class="row" style="padding: 0px;margin: 0px;">
        ...
        <div class="col-sm formato-colum1">
          ...
          <ul class="nav flex-column formato-categoria-filtro">
            <h3>CATEGORÍA <span class="badge badge-info" style="font-size: 30px; margin-left: 5px; letter-spacing: 1px;">BIVIDI</span></h3>
            ...
            <!--Filtros-->
             <div class="container formato-filtro">
                ...
                ?>
              <h2>FILTRAR POR :</h2>
              <form action="filtro_bividi.php" method="GET">
