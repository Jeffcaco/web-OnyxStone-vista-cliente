<?php 
    ...
    if($v1!='Todos' && $v2=='Todos'){
      ...
      e.imagen as imagen1
                                  ...
                                  LEFT JOIN Subcategoria as d on a.idSubcategoria=d.idSubcategoria
                                  LEFT JOIN Imagen as e on a.idProducto=e.idProducto AND e.tipoVista='a'
                WHERE d.nombre='Conjunto sport' AND a.idTalla='$v1'
                GROUP BY c.nombre";
    ...
    if($v1=='Todos' && $v2!='Todos'){
      ...
      e.imagen as imagen1
                                  ...
                                  LEFT JOIN Subcategoria as d on a.idSubcategoria=d.idSubcategoria
                                  LEFT JOIN Imagen as e on a.idProducto=e.idProducto AND e.tipoVista='a'
                WHERE d.nombre='Conjunto sport' AND a.idColor='$v2'
                GROUP BY c.nombre";
    ...
    if($v1!='Todos' && $v2!='Todos'){
      ...
      e.imagen as imagen1
                                  ...
                                  LEFT JOIN Subcategoria as d on a.idSubcategoria=d.idSubcategoria
                                  LEFT JOIN Imagen as e on a.idProducto=e.idProducto AND e.tipoVista='a'
                WHERE d.nombre='Conjunto sport' AND a.idTalla='$v1' AND a.idColor='$v2'
                GROUP BY c.nombre";
